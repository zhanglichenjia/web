...
<head>
<title>Home</title>
<link href="qqq/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
<!-- jQuery (necessary for Bootstrap's JavaScript plugins) -->
<script src="qqq/js/jquery.min.js"></script>
<!-- Custom Theme files -->
<!--theme-style-->
<link href="qqq/css/style.css" rel="stylesheet" type="text/css" media="all" />
<!--//theme-style-->
...
<!-- start-smoth-scrolling -->
		<script type="text/javascript" src="qqq/js/move-top.js"></script>
		<script type="text/javascript" src="qqq/js/easing.js"></script>
 ...
 <div class="header">
	<div class="container">
		<div class="logo animated wow pulse" data-wow-duration="1000ms" data-wow-delay="500ms">
			<h1><a href="index.html"><span>F</span><img src="qqq/images/oo.png" alt=""><img src="qqq/images/oo.png" alt="">uirt</a></h1>
		</div>
		<div class="nav-icon">		
	...
	<!-- start search-->	
		<div class="banner">
			<p class="animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms"><a href="index">首页</a></p>
			<label></label>
			<h4 class="animated wow fadeInTop" data-wow-duration="1000ms" data-wow-delay="500ms">您好，欢迎来到水果</h4>
			<a class="scroll down" href="#content-down"><img src="qqq/images/down.png" alt=""></a>
		</div>
</div>
<!--content-->
		...
		<div class="container">
			<div class="content-top">
				...
				<div class="col-md-8 content-right animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
					<p>The standard chunk of Lorem Ipsum used.<br>随着人们生活水平的提高，健康安全的进口类中高端食品消费必然会成为社会主流的消费趋势，将利用顺丰速运集团资源，放眼优质美食，逐步实现产地直采，缩短供应链，让用户享受到真正0污染、安全健康、优质优价的全球美食。我们愿意为您想得更多、做得更多，我们希望和您一起，成为高品质生活方式的引导者和健康生活理念的传播者</p>
				</div>
				<div class="clearfix"> </div>
			</div>
				...
				<div class="col-md-4 food-grid animated wow fadeInUp" data-wow-duration="1000ms" data-wow-delay="500ms">
					<div class=" hover-fold">
					  ...
					  <div class="top">
						...
						<div class="back face">
						<p>通常品种是一种落叶乔木或灌木，极少数品种为常绿，属于被子植物门双子叶植物纲蔷薇科苹果亚科。</p>
						</div>
					  </div>
				...
				<div class="col-md-4 food-grid animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
					<div class=" hover-fold">
					  ...
					  <div class="top">
						...
						<div class="back face">
						<p>是芸香科柑橘属植物橙树的果实，亦称为黄果、柑子、金环、柳丁。橙子是一种柑果，有很高的食用，药用价值。橙子起源于。</p>
						</div>
					  </div>
				...
				<div class="col-md-4 food-grid animated wow fadeInDown" data-wow-duration="1000ms" data-wow-delay="500ms">
					<div class=" hover-fold">
					  ...
					  <div class="top">
						...
						<div class="back face">
						<p>芒果为著名热带水果之一，芒果果实含有糖、蛋白质、粗纤维，芒果所含有维生素A的前体胡萝卜素成分特别高，是所有水果中少见的。</p>
						</div>
					  </div>
	...
	<div class="container">
		<div class="services-top">		
			<div class="col-md-8 services-right animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
					<p>我们始终从源头把关，新鲜、绿色、天然、原生态。好的土壤，好的种植，全程保质保量，绿色健康，才会有好的品质。品质正宗，营养价值更高！丰富的营养，让您爱不释手!</p>
			</div>
			...
			<div class="col-md-7 service-bottom animated wow fadeInRight" data-wow-duration="1000ms" data-wow-delay="500ms">
				<div class=" service-bottom1">
					<div class=" ser-bottom">
						<img src="qqq/images/sa.jpg" class="img-responsive" alt="">
					</div>
					<div class="ser-top "> 
						<h5>我们 &amp; 的优势</h5>
						<p>全球美食：专享世界特色美食，足不出户坐等全球美味；产地直采：专注原产地采购，国内外直采正品保障；全程冷链：专业冷链存储运输，生鲜美食品质无忧；</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class=" service-bottom1">
					<div class=" ser-bottom">
						<img src="qqq/images/sa1.jpg" class="img-responsive" alt="">
					</div>
					<div class="ser-top "> 
						<h5>我们 &amp;的销售优势</h5>
						<p>水果种类比校外水果摊多，实行开放式的自选，增加顾客的自由 选择性，随意挑选；大学生做销售员，增加与顾客的亲密度；通过现榨果汁等花 式销售增加顾客。</p>
					</div>
					<div class="clearfix"> </div>
				</div>
				<div class=" service-bottom1">
					<div class=" ser-bottom">
						<img src="qqq/images/sa2.jpg" class="img-responsive" alt="">
					</div>
					<div class="ser-top "> 
						<h5>我们 &amp; 的服务特色</h5>
						<p>特色一：提供榨汁服务。特色二：提供组合包装箱。特色三：在店内介绍各种水果的特征和适合食用的人群，引导健康消费，避 免人云亦云的盲目消费</p>
					</div>
					<div class="clearfix"> </div>
				</div>
			</div>
						...
						<a href="single.html">
							<div class="content-item">
								...
								<div class=" news-bottom2">
									...
									<p>猕猴桃的大小和一个鸡蛋差不多，一般是椭圆形的，深褐色并带毛的表皮。</p>
								</div>
							</div>
						</a>
					</div>
		...
		<div class="container">
			<div class="footer-head">
				...
				<div class="col-md-4 footer-bottom  animated wow fadeInLeft" data-wow-duration="1000ms" data-wow-delay="500ms">
					<h2>关于我们</h2>
					<label><i class="glyphicon glyphicon-menu-up"></i></label>
					<p>我们的电话是：188888888<br>我们的地址是：江西省浙江市xx县xx。</p>
					<ul class="social-ic">
						<li><a href="#"><i></i></a></li>
			...
			<p class="footer-class animated wow bounce" data-wow-duration="1000ms" data-wow-delay="500ms">Copyright &copy; 小猪佩奇<a href="http://www.cssmoban.com/" target="_blank" title="模板之家"></a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank"></a></p>
		</div>
	</div>		
	<!--//footer-->
</body>
